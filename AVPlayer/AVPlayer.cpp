...
BEGIN_MESSAGE_MAP(CAVPlayerApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CAVPlayerApp::OnAppAbout)
END_MESSAGE_MAP()


// CAVPlayerApp 构造

CAVPlayerApp::CAVPlayerApp()
{
	// 支持重新启动管理器
	...
	SetAppID(_T("AVPlayer.AppID.NoVersion"));

	// TODO: 在此处添加构造代码，
	// 将所有重要的初始化放置在 InitInstance 中
}

// 唯一的一个 CAVPlayerApp 对象
